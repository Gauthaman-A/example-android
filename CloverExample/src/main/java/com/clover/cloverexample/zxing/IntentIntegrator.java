...
package com.clover.cloverexample.zxing;
...
public class IntentIntegrator {
  ...
  public final AlertDialog initiateScan() {
    ...
    // This stops saving barcode in barcode scanner app's history
    intentScan.putExtra("SAVE_HISTORY", false);
    // Do not delay
    intentScan.putExtra("RESULT_DISPLAY_DURATION_MS", 0L);
    // Message to display when scanning
    intentScan.putExtra("PROMPT_MESSAGE", "Scan Clover Example code");
